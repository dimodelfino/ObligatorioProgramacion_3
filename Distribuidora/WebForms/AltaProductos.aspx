...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenuInvitado" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cpgMenuEmpleado" runat="server">
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div runat="server" id="divNombreProducto">
        ...
        <asp:TextBox ID="txtNombreProducto" Style="margin-left: 30px" runat="server" Width="127px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtDescProd" Style="margin-left: 10px" runat="server" Width="127px"></asp:TextBox>    
    ...
    <asp:TextBox ID="txtCostoProd" TextMode="Password" Style="margin-left: 45px" Width="127px" runat="server"></asp:TextBox>    
    ...
    <div runat="server" id="divFabricado">
        ...
        <asp:TextBox ID="txtTiempoFab" Style="margin-left: 5px" Width="127px" runat="server"></asp:TextBox>
    ...
    <div runat="server" id="divImportado">
        <asp:Label ID="lblOrigen" Style="margin-left: 10px; margin-right: 158px" runat="server" Text="Origen "></asp:Label>
        ...
        <asp:TextBox ID="txtCantImp" Style="margin-left: 5px" Width="127px" runat="server"></asp:TextBox>
    ...
    <br />
    <asp:Button ID="btnAgregarProducto" runat="server" Text="Agregar Usuario" Style="margin-top: 20px; margin-left: 10px" OnClick="btnAgregarProducto_Click"/>
</asp:Content>
